...
$formproc->AddRecipient('ivandas84@outlook.com'); //<<---Put your email address here
$formproc->AddRecipient('ivanivanivan007@gmail.com');
$formproc->AddRecipient('info@ats-in.com');
